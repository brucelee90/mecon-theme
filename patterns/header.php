...
<div class="wp-block-group">
    ...
    <div class="wp-block-group alignwide"
        ...
        <div class="wp-block-group">
            <!-- wp:navigation {"overlayBackgroundColor":"base","overlayTextColor":"contrast","layout":{"type":"flex","orientation":"horizontal","flexWrap":"nowrap"}} /-->
        </div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-group" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
            <!-- wp:mecon-blocks/buttons {"text":"\u003ca href=\u0022/kontakt\u0022\u003eJetzt Anfrage stellen\u003c/a\u003e"} /-->
        </div>
        <!-- /wp:group -->
    </div>
    <!-- /wp:group -->
